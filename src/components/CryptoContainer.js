...
import { View, TouchableHighlight, ScrollView, Text, Image } from 'react-native';
    ...
    return crypto.data.map((coin, index) => {
      ...
      return (
          <TouchableHighlight underlayColor={'lightgrey'}
            activeOpacity={0.5} key={coin.name + coin.price_usd + 'th'} onPress={() => this._handleNextPress(nextRoute, coin.symbol)}>
            <CoinCard
              key={coin.name + coin.price_usd}
              coin_name={coin.name}
